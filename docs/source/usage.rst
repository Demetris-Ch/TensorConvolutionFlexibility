...
This Python Script includes all functions of the developed package.

.. automodule:: FA_Estimator
    :members:
    :noindex:

Convolution Simulations
------------------------

This Python Script includes all functions applying tensor convolutions to estimate flexibility areas.

.. automodule:: conv_simulations
    :members:
    :noindex:
...
This Python Script includes all functions applying Monte-Carlo based simulations.
...
This Python Script includes all functions sampling FSP shifts.

.. automodule:: data_sampler
    :members:
    :noindex:
...
This Python Script reads the scenario information.

.. automodule:: json_reader
    :members:
    :noindex:
...
This Python Script includes all functions plotting the csv results.
...
This Python Script includes all functions setting up the network and scenario parameters.

.. automodule:: scenario_setup
    :members:
    :noindex:
...
This Python Script includes all functions used to estimate the accuracy.

.. automodule:: accuracy_estimation
    :members:
    :noindex:
...
This Python Script includes all generic functions.
...
This Python Script includes the functions used for the opf.
...
This python script is the main file calling the rest of the scripts.
...
-------------------------------------------------------------------
VI. Files for IEEE Transactions on Smart Grid Publication Scenarios
-------------------------------------------------------------------
...
VI.A) Accuracy in Population Estimation
---------------------------------------
...
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC1/Compare_Flexibility_area_BruteOb0_2.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC1/Conv_multi_Conv_Conv_Brute_Ob0_2.svg
  :width: 400

VI.B) Speed and Range Accuracy
---------------------------------

The CSV results are under **csv_results/UC2**
The figures are saved under **plots/UC2**

.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC2/Loop/Kumaraswamy_MC_Oberrhein0_4FSPs_20_8.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC2/Loop/Uniform_MC_Oberrhein0_4FSPs_20_8.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC2/Loop/Hard_MC_Oberrhein0_4FSPs_20_8.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC2/Oberrhein0_speed_log.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC2/Oberrhein0W_speed_log.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC2/Oberrhein1_speed_log.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC2/Conv_multi_Conv_LargeRadial.svg
  :width: 400

VI.C) Disjoint Flexibility Areas
---------------------------------
...
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC3/Disc_Scenario_121416012388_incl_infeasible.jpg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC3/Conv_multi_Conv_Conv_Discontinuous.svg
  :width: 400

VI.D) Uncertainty Estimation for Small FSPs
-------------------------------------------
The results are in the **csv_results/UC4** folder.
Example figure generated for the scenario is in the folder **plots/UC4**

.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC4/Uncertainty_Interpreted.png
  :width: 400
...
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC5/TCP_Conv_SaveTsOb0.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC5/TCP_Conv_NoLoadFlexOb0.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC5/TCP_Conv_LoadFlexOb0.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC5/TCP_Conv_SaveFaTs.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC5/TCP_Conv_NoLoadTs_ax.svg
  :width: 400
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC5/TCP_Conv_LoadTs_ax.svg
  :width: 400


VI.F) Case study for DFC
-------------------------------------------
The results are in the **csv_results/UC6** folder.
Example figures generated for the scenario are in the folder **plots/UC6**

.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC6/feas_mat.svg
  :width: 250
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC6/heat_mat.svg
  :width: 250
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC6/min_cmat.svg
  :width: 250
.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC6/nflex_mat.svg
  :width: 250


VI.G) Case study for OPFs
-------------------------------------------

Example figure generated for this scenario is in the folder **plots/UC7**

.. image:: https://github.com/Demetris-Ch/TensorConvolutionFlexibility/blob/main/plots/UC7/OPF_.svg
  :width: 500
